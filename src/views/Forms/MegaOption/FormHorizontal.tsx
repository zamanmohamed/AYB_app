                                    ...
                                    <Col lg={6}>
                                        <Card className="border p-3">
                                            <div className="form-check">
                                                <input type="radio" name="radio3" className="form-check-input input-primary" id="customCheckdefhor2" />
                                                <label className="form-check-label d-block" htmlFor="customCheckdefhor2">
                                                    <span>
                                                        <span className="h5 d-block"><strong className="float-end">$&nbsp;8.00</strong>Premium plan</span>
                                                        <span className="f-12 text-muted">
